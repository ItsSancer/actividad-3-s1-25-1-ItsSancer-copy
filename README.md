...
4. El workflow debe ejecutar las siguientes tareas:
   ...
   - Este `README.md` contiene un campo de versión como el siguiente:
     ...
     ```
   - Tu workflow debe actualizar automáticamente este número de versión siguiendo el esquema `v<major>.<minor>.<patch>`, por ejemplo: `v1.0.5`, `v1.1.0`, etc.
   - Para simplificar, puedes incrementar siempre el patch (`v1.0.0` → `v1.0.5`).
